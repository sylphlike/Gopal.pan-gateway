 ...
 */
@Component
public class PostFormRequestHandler extends AbstractRequestHandler {
    @Override
    public String requestContentType() {
        return HttpMethod.POST.toString() + CharsetUtil.CHAR_ENGLISH_DASHED + MediaType.APPLICATION_FORM_URLENCODED_VALUE;
    }
