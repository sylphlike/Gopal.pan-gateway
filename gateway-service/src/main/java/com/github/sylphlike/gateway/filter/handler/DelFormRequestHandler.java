 ...
 */
@Component
public class DelFormRequestHandler extends AbstractRequestHandler {
    @Override
    public String requestContentType() {
        return HttpMethod.DELETE.toString() + CharsetUtil.CHAR_ENGLISH_DASHED + MediaType.APPLICATION_FORM_URLENCODED_VALUE;
    }

    @Override
    public Mono<Void> distributionExecution(ServerWebExchange exchange, GatewayFilterChain chain, String path) {

        return universal(exchange, chain, path, ParamsType.FORM_DATA ,"DEL FORM 请求");
